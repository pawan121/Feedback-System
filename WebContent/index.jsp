...
<div  style="position:fixed;width:100%;">
    ...
    <div class="navbar-inner">
        <div class="container"> <a data-target=".navbar-responsive-collapse" data-toggle="collapse" class="btn btn-navbar">
            ...
            <a href="Home.aspx" class="brand">FeedBack System</a>
    ...
    <br /><br /><br /><br />
<img src="im.jpg" height="2000px" width="2000px" alt="Koala" style="border:1px solid red;margin:100px,10px,0px,10px;"/>
